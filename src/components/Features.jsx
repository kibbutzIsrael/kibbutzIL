    ...
    >
      ...
      >
        ...
        <p className="lead text-center mb-5">
          לייצר אימפקט משמעותי ולהשפיע על החברה הישראלית{" "}
        </p>
        <div className="row">
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-12">
                <div className="featured-box featured-box-reverse-xl style-3 mb-5">
                  ...
                  <p>ליצור חוויות משותפות ולשדרג את האופי החברתי של הקהילה.</p>
                </div>
              </div>
              <div className="col-md-6 col-lg-12">
                <div className="featured-box featured-box-reverse-xl style-3 mb-5">
                  ...
                  <p>
                    תרומה יכולה ליצור דינמיקה של שיתוף פעולה וחידוש בפרויקטים
                    ומיזמים שמתבצעים בקרבת הקהילה.
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-12">
                <div className="featured-box featured-box-reverse-xl style-3 mb-5">
                  ...
                  <p>
                    השתתפות בתרומה לקהילה יכולה להבטיח פיתוח אישי ומקצועי, דרך
                    ראיית עולם רחבה יותר ומקום לחשיבה יצירתית.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-12">
                <div className="featured-box style-3 mb-5">
                  ...
                  <p>
                    תרומה יכולה ליצור אימפקט חברתי ממשי, ולסייע לאנשים ולקהילות
                    במגוון דרכים, מתן עזרה לאחרים ויצירת שיפור כלכלי וחברתי.
                    סה"כ, התרומה
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-12">
                <div className="featured-box style-3 mb-5">
                  ...
                  <p>
                    התרומה מקנה תחושה של משמעות וסיפוק כיוון שהיא מעניקה לך
                    הזדמנות לתרום ולהשפיע בצורה חיובית.
                  </p>
                </div>
              </div>
              <div className="col-md-6 col-lg-12">
                <div className="featured-box style-3 mb-5">
                  ...
                  <p>
                    השתתפות בפעילויות קהילתיות ותרומה מאפשרים לך לבנות קשרים
                    חברתיים, להכיר אנשים חדשים ולהרחיב את רשת ההכרויות שלך.
                  </p>
                </div>
              </div>
            </div>
